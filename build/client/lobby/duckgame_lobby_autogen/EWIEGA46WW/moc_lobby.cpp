...
struct qt_meta_stringdata_CLASSlobbyENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSlobbyENDCLASS = QtMocHelpers::stringData(
    "lobby"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSlobbyENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject lobby::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSlobbyENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSlobbyENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSlobbyENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *lobby::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSlobbyENDCLASS.stringdata0))
